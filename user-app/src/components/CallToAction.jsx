    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="rounded-3xl overflow-hidden flex flex-col md:flex-row bg-white text-black ">
        ...
        <div className="md:w-1/2 w-full flex flex-col justify-center px-8 py-10">
          ...
          <a  href="https://www.puppergo.sbs" className="bg-[#0E2148] hover:opacity-90 text-white font-semibold rounded-full px-6 py-3 text-sm md:text-base flex items-center w-max transition">
